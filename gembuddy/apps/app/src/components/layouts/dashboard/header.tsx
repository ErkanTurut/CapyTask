...
export default function Header({}: headerProps) {
  return (
    <div
      className={cn(
        "group/btn sticky top-0 flex h-[49px] w-full items-center justify-between border-b border-border p-2 shadow-none backdrop-blur-sm transition-all duration-200"
      )}
    >
