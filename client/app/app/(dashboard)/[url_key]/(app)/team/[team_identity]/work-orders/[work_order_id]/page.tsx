...
import StepTable from "./_components/step-table";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <main className="container grid flex-1 items-start gap-4 sm:py-0 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
        ...
        <Tabs defaultValue="week">
          ...
          <TabsContent value="week">
            <Card x-chunk="dashboard-05-chunk-3">
              ...
              <CardContent>
                <StepTable steps={work_order.work_step_status} />
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
