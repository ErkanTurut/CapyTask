      ...
      <CardHeader className="pb-4">
        ...
        <div className="flex gap-2">
          <Link
            ...
            href={{
              pathname: `/${params.url_key}/team/${params.team_identity}/templates/inspections/${params.work_plan_template_id}/search`,
              query: { q: "" },
            }}
          >
          ...
          <Link
            ...
            href={{
              pathname: `/${params.url_key}/team/${params.team_identity}/templates/inspections/${params.work_plan_template_id}/create`,
            }}
          >
