...
CREATE TABLE IF NOT EXISTS "public"."work_order" (
    ...
    "source" "public"."WorkOrderSource" NOT NULL,
    "requested_by_id" "uuid",
    "workspace_id" "text" NOT NULL,
    "ended_at" timestamp(6) with time zone,
    "started_at" timestamp(6) with time zone,
    "sheduled_range" "tstzrange" NOT NULL
);
...
CREATE INDEX "service_appointment_team_id_idx" ON "public"."service_appointment" USING "btree" ("team_id");
...
CREATE INDEX "service_appointment_workspace_id_idx" ON "public"."service_appointment" USING "btree" ("workspace_id");
...
ALTER TABLE ONLY "public"."service_appointment"
    ADD CONSTRAINT "service_appointment_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."team"("id") ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."service_appointment"
    ADD CONSTRAINT "service_appointment_work_order_id_fkey" FOREIGN KEY ("work_order_id") REFERENCES "public"."work_order"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."service_appointment"
    ADD CONSTRAINT "service_appointment_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspace"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
